...
export default function PlatformTenantManagePCView(props: PlatformTenantManageViewProps) {
  const {
    tenantIdValid,
    tenant,
    tenantLoading,
  ...
  return (
    <main className="page platform-admin-page platform-tenant-manage-page platform-tenant-manage-page--pc page--with-back">
