...
export type LiquorSignatureAttachmentReviewModalProps = {
  open: boolean
  onClose: () => void
  linkCode: string
  attachment: LiquorSignatureSendSessionAttachmentPublic | null
...
export function LiquorSignatureAttachmentReviewModal({
  open,
  onClose,
  linkCode,
  attachment,
  ...
  onConfirmed,
  onActionError,
}: LiquorSignatureAttachmentReviewModalProps) {
