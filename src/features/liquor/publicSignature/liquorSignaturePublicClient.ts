...
export async function fetchContractPublicSession(linkCode: string): Promise<ContractPublicSessionPayload> {
  return publicRequest<ContractPublicSessionPayload>(`/api/liquor/signatures/public/${lc(linkCode)}`)
}

export async function postContractPublicOpen(linkCode: string): Promise<{ opened: boolean; metaRecorded?: boolean }> {
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/open`, {
    method: 'POST',
    body: JSON.stringify({}),
  })
}
...
export async function fetchContractPublicDocuments(linkCode: string): Promise<{ documents: ContractDocumentRow[] }> {
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/documents`)
}
...
export async function postContractOtpSend(linkCode: string): Promise<{
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/otp/send`, {
    method: 'POST',
    body: JSON.stringify({}),
  })
}
...
export async function postContractOtpVerify(linkCode: string, code: string): Promise<{ verified?: boolean; status?: string }> {
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/otp/verify`, {
    method: 'POST',
...
export async function fetchContractOtpStatus(linkCode: string): Promise<{
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/otp/status`)
}
...
export type ContractDocumentDetailPayload = {
  ...
  completed?: boolean
  /** confirmation_only: liquor_signature_evidences 행 존재 시 true */
  ...
  sendSessionAttachments?: LiquorSignatureSendSessionAttachmentPublic[]
}

export type LiquorSignatureSendSessionAttachmentPublic = {
  id: string
...
export function resolveContractAttachmentViewAbsUrl(linkCode: string, attachmentId: string): string {
  return resolveApiUrl(`/api/liquor/signatures/public/${lc(linkCode)}/attachments/${lc(attachmentId)}/view`)
}
...
export async function postContractPublicAttachmentConfirm(
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/attachments/${lc(attachmentId)}/confirm`, {
    method: 'POST',
    body: JSON.stringify({}),
  })
}
...
export async function fetchContractPublicDocumentDetail(
  ...
  const data = await publicRequest<ContractDocumentDetailPayload>(
    `/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}`,
  )
...
export function resolveContractPdfPreviewAbsUrl(linkCode: string, documentInstanceId: string): string {
  return resolveApiUrl(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/pdf`)
}
...
export function resolveContractRenderedPdfAbsUrl(
  ...
  const base = resolveApiUrl(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/rendered-pdf`)
  const q = mode === 'input' ? '?mode=input' : '?mode=final'
  return `${base}${q}`
}

export function resolveLiquorSignedPdfAbsUrl(linkCode: string, documentInstanceId: string): string {
  return resolveApiUrl(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/signed-pdf`)
}
...
export async function postContractPublicDocumentValues(
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/values`, {
    method: 'POST',
...
export async function postContractPublicDocumentSign(
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/sign`, {
    method: 'POST',
    body: JSON.stringify(body),
  })
}
...
export async function postContractPublicDocumentComplete(
  ...
  return publicRequest(`/api/liquor/signatures/public/${lc(linkCode)}/documents/${lc(documentInstanceId)}/complete`, {
    method: 'POST',
    body: JSON.stringify(body),
  })
}
