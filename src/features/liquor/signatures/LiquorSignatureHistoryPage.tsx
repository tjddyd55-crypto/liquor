...
import '../signatures/liquor-signature-send-mobile.css'
...
} from './liquorSignatureHistoryClient'
...
export default function LiquorSignatureHistoryPage() {
        ...
        <section className="contract-signature-console__section">
            ...
            <>
              <div className="contract-history-mobile-toolbar">
                ...
                <FormButton
                  ...
                  disabled={!t}
                  onClick={() => navigate('/liquor/signatures/send')}
                >
                  새 발송
                </FormButton>
              </div>
          ...
          {!listBusy && rows.length === 0 && !listError ? (
            <div>
              ...
              <Link className="contract-signature-console__hint" to="/liquor/signatures/send">
                전자서명 발송하기
              </Link>
            </div>
          ) : (
