...
import { liquorSignatureObjectRootPrefix } from '../../lib/liquorSignatureStorage.js'

const KEY_PREFIX = liquorSignatureObjectRootPrefix()
 ...
 */
export function buildLiquorPdfTemplateStorageKey({ gaId, code }) {
 ...
 * @param {Buffer} body
 */
export function putLiquorPdfTemplateObject(key, body) {
 ...
 */
export function getLiquorPdfTemplateObject(key) {
 ...
 * @param {string} key
 */
export function deleteLiquorPdfTemplateObject(key) {
