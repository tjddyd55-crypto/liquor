...
import { listConfirmationItemsWithValues } from './liquorSignatureConfirmationItems.js'
import { listSendSessionAttachmentsPublic } from './liquorSignatureSendAttachments.js'
...
async function loadDocuments(pool, sendSessionId) {
  const r = await pool.query(
    ...
    LEFT JOIN liquor_pdf_templates pt ON pt.id = ct.pdf_template_id
